...
const NavBar = () => {
  ...
  const links = [
    { id: 0, name: locale.NAV.INDEX, to: BLOG.path || 'https://cl96.top', show: true },
...
export default function Header ({ navBarTitle, fullWidth }) {
  ...
  const resolveFavicon = fallback => '/favicon.png'
  ...
  return (
    <>
      ...
      <div
        className={`sticky-nav group m-auto w-full h-6 flex flex-row justify-between items-center mb-2 py-8 bg-opacity-60 ${
